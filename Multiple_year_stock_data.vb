Sub MultipleYearStockData():
 ...
 Sht_Count = ActiveWorkbook.Worksheets.Count
    ...
    For Each Sht In Worksheets
     ...
     'Setting Headers for each Sheet and format them as BOLD, WHITE on a Black background
    
     Sht.Cells(1, 9).Value = "Ticker"
     Sht.Cells(1, 9).Font.Bold = True
     Sht.Cells(1, 9).Interior.ColorIndex = 1
     Sht.Cells(1, 9).Font.Color = RGB(255, 255, 255)
     Sht.Cells(1, 10).Value = "Yearly Change"
     Sht.Cells(1, 10).Font.Bold = True
     Sht.Cells(1, 10).Interior.ColorIndex = 1
     Sht.Cells(1, 10).Font.Color = RGB(255, 255, 255)
     Sht.Cells(1, 11).Value = "Percent Change"
     Sht.Cells(1, 11).Font.Bold = True
     Sht.Cells(1, 11).Interior.ColorIndex = 1
     Sht.Cells(1, 11).Font.Color = RGB(255, 255, 255)
     Sht.Cells(1, 12).Value = "Total Stock Volume"
     Sht.Cells(1, 12).Font.Bold = True
     Sht.Cells(1, 12).Interior.ColorIndex = 1
     Sht.Cells(1, 12).Font.Color = RGB(255, 255, 255)
    
     Sht.Cells(2, 15).Value = "Greatest % Increase"
     Sht.Cells(2, 15).Font.Bold = True
     Sht.Cells(2, 15).Interior.ColorIndex = 1
     Sht.Cells(2, 15).Font.Color = RGB(255, 255, 255)
     
     Sht.Cells(3, 15).Value = "Greatest % Decrease"
     Sht.Cells(3, 15).Font.Bold = True
     Sht.Cells(3, 15).Interior.ColorIndex = 1
     Sht.Cells(3, 15).Font.Color = RGB(255, 255, 255)
     Sht.Cells(4, 15).Value = "Greatest Total Volume"
     Sht.Cells(4, 15).Font.Bold = True
     Sht.Cells(4, 15).Interior.ColorIndex = 1
     Sht.Cells(4, 15).Font.Color = RGB(255, 255, 255)
    
     Sht.Cells(1, 16).Value = "Ticker"
     Sht.Cells(1, 16).Font.Bold = True
     Sht.Cells(1, 16).Interior.ColorIndex = 1
     Sht.Cells(1, 16).Font.Color = RGB(255, 255, 255)
     Sht.Cells(1, 17).Value = "Value"
     Sht.Cells(1, 17).Font.Bold = True
     Sht.Cells(1, 17).Interior.ColorIndex = 1
     Sht.Cells(1, 17).Font.Color = RGB(255, 255, 255)
